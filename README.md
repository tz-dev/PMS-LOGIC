...
**PMS–LOGIC is a formal application of the [Praxeological Meta-Structure (PMS)](https://github.com/tz-dev/Praxeological-Meta-Structure-Theory)** — a generative operator framework (Δ–Ψ) for modelling praxis, asymmetry, temporality, and self-binding.
...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.19440215.svg)](https://doi.org/10.5281/zenodo.19440215)
...
They function as **operator-legible scene packets** that stress-test PMS–LOGIC under load:
...
Responsibility is reconstructed as **attributability of consequences**,
